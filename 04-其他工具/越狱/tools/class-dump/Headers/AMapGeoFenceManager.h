...
- (void)amapLocationManager:(id)arg1 doRequireTemporaryFullAccuracyAuth:(id)arg2 completion:(CDUnknownBlockType)arg3;
- (void)amapLocationManager:(id)arg1 locationManagerDidChangeAuthorization:(id)arg2;
