...
@class AMapLocationReGeocode, AMapNetworkManager, CLLocation, CLLocationManager, NSArray, NSDate, NSMapTable, NSMutableArray, NSOperationQueue, NSSet, NSString;
...
@interface AMapLocationManager : NSObject <CLLocationManagerDelegate, AMapLocationRequestDelegate>
{
    ...
    long long _locationAccuracyMode;
    AMapNetworkManager *_networkManager;
    NSDate *_firstLoactionDtate;
...
@property(retain) NSDate *firstLoactionDtate; // @synthesize firstLoactionDtate=_firstLoactionDtate;
@property _Bool isFirstLocation; // @synthesize isFirstLocation=_isFirstLocation;
...
@property(nonatomic) long long locationAccuracyMode; // @synthesize locationAccuracyMode=_locationAccuracyMode;
...
- (void)locateDidCompletedWithLocation:(id)arg1 regeocode:(id)arg2;
...
- (void)didAuthorizationChanged:(id)arg1 auth:(int)arg2;
- (void)locationManagerDidChangeAuthorization:(id)arg1;
- (void)locationManager:(id)arg1 didChangeAuthorizationStatus:(int)arg2;
- (void)locationManager:(id)arg1 didUpdateLocations:(id)arg2;
- (void)locationManager:(id)arg1 didFailWithError:(id)arg2;
- (void)processLocationInfo:(id)arg1;
- (void)statisticLocationInfo:(id)arg1 error:(id)arg2 manmager:(id)arg3;
...
- (void)forceCompleteAllRequestsForFullAccuracyError:(id)arg1;
...
- (void)handlRequestStateForRegion:(id)arg1;
...
- (void)handleStopUpdatingLocation;
...
@property(readonly, nonatomic) long long currentAuthorization;
...
- (void)dealloc;
- (void)handleCloudConfigs:(id)arg1;
- (void)handleAuthUpdateNotification:(id)arg1;
- (id)init;
