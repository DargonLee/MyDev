...
@class AMapLocationManager, AMapLocationReGeocode, AMapLocationRegion, CLHeading, CLLocation, CLLocationManager, NSError;
...
- (void)amapLocationManager:(AMapLocationManager *)arg1 locationManagerDidChangeAuthorization:(CLLocationManager *)arg2;
...
- (void)amapLocationManager:(AMapLocationManager *)arg1 doRequireLocationAuth:(CLLocationManager *)arg2;
- (void)amapLocationManager:(AMapLocationManager *)arg1 doRequireTemporaryFullAccuracyAuth:(CLLocationManager *)arg2 completion:(void (^)(NSError *))arg3;
@end
