...
+ (id)requestWithReformer:(id)arg1 withURL:(id)arg2 timeout:(double)arg3;
+ (id)requestWithReformer:(id)arg1 withURL:(id)arg2;
+ (id)requestWithReformer:(id)arg1;
+ (id)v6RequestWithReformer:(id)arg1;
+ (id)requestWithReformer:(id)arg1 timeout:(double)arg2;
+ (id)v6RequestWithReformer:(id)arg1 timeout:(double)arg2;
...
+ (id)reformerWithFutureRouteSearchRequest:(id)arg1;
