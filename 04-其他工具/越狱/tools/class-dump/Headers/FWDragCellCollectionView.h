...
@protocol FWDragCellCollectionViewDelegate, FWDragCollectionViewDataSource;

@interface FWDragCellCollectionView : UICollectionView
{
    _Bool _canDrag;
    _Bool _isEndDrag;
...
@property(nonatomic) __weak id <FWDragCollectionViewDataSource> dataSource; // @dynamic dataSource;
@property(nonatomic) __weak id <FWDragCellCollectionViewDelegate> delegate; // @dynamic delegate;
