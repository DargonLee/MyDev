...
@class GMSAnalyticsTimer, GMSDisplayLink, GMSFramerateMonitor, GMSIOSGLContext, GMSScreenInfo, NSString, NSTimer, UIColor, UIImageView;
...
- (_Bool)setupOpenGLOffscreen:(id)arg1;
- (void)dealloc;
- (id)initWithFrame:(struct CGRect)arg1 displayLink:(id)arg2 offscreenSink:(id)arg3 externalTime:(struct Time *)arg4;
- (id)rendererLayer;
