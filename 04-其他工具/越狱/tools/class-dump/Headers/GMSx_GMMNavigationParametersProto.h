...
@property(nonatomic) _Bool enableExpandableArrivalCard; // @dynamic enableExpandableArrivalCard;
...
@property(nonatomic) _Bool hasEnableExpandableArrivalCard; // @dynamic hasEnableExpandableArrivalCard;
