...
@class JCommonActiveUserController, JCommonBatteryController, JCommonCrashController, JCommonDeviceController, JCommonLocationController, JCommonPasteController, JCommonPhoneController;
...
@interface JCommonServiceController : NSObject
{
    ...
    JCommonPhoneController *_phoneController;
