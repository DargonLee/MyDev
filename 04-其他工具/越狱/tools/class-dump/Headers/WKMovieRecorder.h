...
@class AVAssetWriterInputPixelBufferAdaptor, AVCaptureConnection, AVCaptureDevice, AVCaptureDeviceInput, AVCaptureSession, AVCaptureStillImageOutput, AVCaptureVideoDataOutput, AVCaptureVideoPreviewLayer, NSDictionary, NSMutableArray, NSString, NSTimer, NSURL, UIImage, WKMovieWriter;
