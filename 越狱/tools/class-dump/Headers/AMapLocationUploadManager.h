...
@class AMapCacheFileManager, AMapNetworkManager, NSMutableArray, NSMutableDictionary;
...
@interface AMapLocationUploadManager : NSObject
{
    ...
    NSMutableDictionary *_uploadStatistic;
}

+ (id)sharedInstance;
- (void).cxx_destruct;
@property(retain) NSMutableDictionary *uploadStatistic; // @synthesize uploadStatistic=_uploadStatistic;
...
- (void)reloadLastUploadFilesForWWAN;
- (void)updateLastUploadFiles:(unsigned long long)arg1;
- (void)reloadLastUploadTimestamp;
- (void)saveLastUploadTimestamp;
- (void)reachabilityChanged:(id)arg1;
- (void)receiveNetworkOKNotification:(id)arg1;
- (void)updateControlWithResponse:(id)arg1;
- (_Bool)isUploadSucceededWithResponseData:(id)arg1;
- (_Bool)shouldUploadForTimespan;
- (_Bool)shouldUploadForWWANNet;
- (_Bool)shouldUploadForWIFINet;
- (void)uploadDatas:(id)arg1 completeBlock:(CDUnknownBlockType)arg2;
- (void)uploadCacheFile;
- (void)uploadSubCacheFile:(unsigned long long)arg1;
- (void)uploadCacheFileIfNeeded;
- (void)deleteOldestFile;
- (void)clearCacheLogs;
- (void)removeCacheLogFiles:(id)arg1;
