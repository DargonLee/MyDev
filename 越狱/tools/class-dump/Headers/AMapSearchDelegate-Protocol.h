...
@class AMapBusLineBaseSearchRequest, AMapBusLineSearchResponse, AMapBusStopSearchRequest, AMapBusStopSearchResponse, AMapCloudPOISearchResponse, AMapCloudSearchBaseRequest, AMapDistanceSearchRequest, AMapDistanceSearchResponse, AMapDistrictSearchRequest, AMapDistrictSearchResponse, AMapFutureRouteSearchResponse, AMapGeocodeSearchRequest, AMapGeocodeSearchResponse, AMapInputTipsSearchRequest, AMapInputTipsSearchResponse, AMapNearbySearchRequest, AMapNearbySearchResponse, AMapPOISearchBaseRequest, AMapPOISearchResponse, AMapReGeocodeSearchRequest, AMapReGeocodeSearchResponse, AMapRoutePOISearchRequest, AMapRoutePOISearchResponse, AMapRouteSearchBaseRequest, AMapRouteSearchResponse, AMapShareSearchBaseRequest, AMapShareSearchResponse, AMapWeatherSearchRequest, AMapWeatherSearchResponse, NSError;
...
- (void)onFutureRouteSearchDone:(AMapRouteSearchBaseRequest *)arg1 response:(AMapFutureRouteSearchResponse *)arg2;
