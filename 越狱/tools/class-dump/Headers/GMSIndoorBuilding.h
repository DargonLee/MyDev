...
- (id)initWithIndoorID:(struct GMSFeatureID)arg1 levels:(id)arg2 center:(struct Point2D)arg3 minRenderingZoom:(int)arg4 underground:(_Bool)arg5 defaultLevelIndex:(unsigned long long)arg6;
