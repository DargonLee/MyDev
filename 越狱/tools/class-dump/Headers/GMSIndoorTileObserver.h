...
@interface GMSIndoorTileObserver : GMSTileFetchingTileObserver
{
    ...
    struct unique_ptr<gmscore::utils::LRUCache<GMSFeatureID, GMSIndoorBuilding *, gmscore::model::GMSFeatureIDHashFunc, gmscore::model::GMSFeatureIDEqualFunc, false>, std::__1::default_delete<gmscore::utils::LRUCache<GMSFeatureID, GMSIndoorBuilding *, gmscore::model::GMSFeatureIDHashFunc, gmscore::model::GMSFeatureIDEqualFunc, false>>> _buildingCache;
