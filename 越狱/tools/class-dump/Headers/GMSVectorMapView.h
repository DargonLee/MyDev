...
@interface GMSVectorMapView : GMSGestureHandlerView <UIGestureRecognizerDelegate, GMSIndoorFocusDelegate, GMSIndoorStateListener, GMSIndoorTileObserverDelegate, GMSMyLocationEntityProviderDelegate, GMSAccessibilityContainer, GMSEntityUIHandler, GMSIOS10Compat_CAAnimationDelegate>
{
