...
@class KWApiAsyncReadPacket, KWApiAsyncSocketPreBuffer, KWApiAsyncWritePacket, NSData, NSMutableArray;
@protocol OS_dispatch_queue, OS_dispatch_source;

@interface KWApiAsyncSocket : NSObject
{
    unsigned int flags;
