...
@class NSTimer, SVProgressAnimatedView, SVRadialGradientLayer, UIColor, UIControl, UIFont, UIImage, UIImageView, UILabel, UINotificationFeedbackGenerator, UIVisualEffectView, UIWindow;
